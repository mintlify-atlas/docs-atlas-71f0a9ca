---
title: 'Changelog'
description: 'Version history and release notes for Synkra AIOX'
icon: 'clock-rotate-left'
---

<Info>
  All notable changes to Synkra AIOX are documented in this file.
...
<AccordionGroup>
  <Accordion title="[4.2.11] - 2026-02-16" icon="plus" defaultOpen>
    ### Added
  ...
  <Accordion title="[4.2.10] - 2026-02-16" icon="wrench">
    ### Fixed
  ...
  <Accordion title="[4.2.9] - 2026-02-16" icon="wrench">
    ### Fixed
  ...
  <Accordion title="[4.2.8] - 2026-02-16" icon="wrench">
    ### Fixed
  ...
  <Accordion title="[4.2.7] - 2026-02-16" icon="wrench">
    ### Fixed
  ...
  <Accordion title="[Unreleased]" icon="flask">
    ### Added
  ...
  <Accordion title="[3.9.0] - 2025-12-26" icon="stars">
    ### Highlights
  ...
  <Accordion title="[3.8.0] - 2025-12-26" icon="box">
    *Previous release with WIS and SQS features.*
  </Accordion>
  
  <Accordion title="[2.2.3] - 2025-12-22" icon="rocket">
    ### Highlights
    ...
    <CardGroup cols={2}>
      <Card title="Legal Foundation" icon="scale-balanced">
        - Privacy policies (EN/PT)
        - Terms of use (EN/PT)
        - Community guidelines with contact info
      </Card>
      
      <Card title="Community Process" icon="users">
      ...
      <Card title="Squads Guide" icon="people-group">
        - Comprehensive guide for creating squads
        - Examples and best practices
      </Card>
      
      <Card title="Synkra Rebranding" icon="paintbrush">
        - Brand investigation complete
        - Namespace updated to SynkraAI
      </Card>
      
      <Card title="Release Checklist" icon="list-check">
        - GitHub configuration validated
        - CodeQL security scanning (30+ alerts addressed)
  ...
  <Accordion title="[4.32.0] - 2025-11-12" icon="trash">
    ### Removed
    ...
    - **Squad naming convention** - Applied consistent `{agent-id}-` prefix to agent-specific tasks across all 6 squads
      - ETL pack: 4 tasks renamed
      - Creator pack: 4 tasks already renamed
      - Innerlens pack: 4 tasks renamed
      - Mmos-mapper pack: 7 tasks renamed
      - All agent dependencies updated to reference new task names
      - Shared tasks correctly have NO prefix
    ...
    - Story: 4.7 - Removed `squads/hybrid-ops.legacy/` directory
    - Story: 4.5.3 - Squads Naming Convention Migration
  </Accordion>
  
  <Accordion title="[4.31.1] - 2025-10-22" icon="wrench">
    ### Added
  ...
  <Accordion title="[4.31.0] - Previous Release" icon="box">
...
<CardGroup cols={2}>
  <Card title="GitHub Releases" icon="github" href="https://github.com/SynkraAI/aiox-core/releases">
    View all releases on GitHub
  </Card>
  <Card title="npm Package" icon="npm" href="https://www.npmjs.com/package/aiox-core">
    Install via npm
  </Card>
</CardGroup>
